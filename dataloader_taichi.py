...
class TaiChiDataset(Dataset):
    ...
    def __init__(self, root_dir, split='train', input_length=10, target_length=10,
...
def load_data(root_dir="/datasets/tai-chi/taichi_png", batch_size=8, image_size=128,
    ...
    test_dataset = TaiChiDataset(root_dir=root_dir, split='test',
                                 input_length=input_length, target_length=target_length,
                                 image_size=image_size)
